...
#set path to JavaScript engine and name of a resulting file
path_v8 = ""
result_name = ""
if len(sys.argv) > 1 and sys.argv[1] == "-n":
    path_v8 = "node"
    result_name = "/result_node.csv"
else:
    path_v8 = "/Users/Evgeniy/Development/git/v8/out/x64.release/shell"
    result_name = "/result_v8.csv"
...
for test_file in tests:
    ...
    start = time.time()    
    cmd_v8 = path_v8+' '+ test_file.path_to_file
    ...
    print 'FINISH  **********************************************************************'
    print test_file.path_to_file
    print '_______________________________________________________________________________'

csvfile = open(path_results + result_name, 'w+')
